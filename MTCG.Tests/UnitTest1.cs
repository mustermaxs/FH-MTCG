...
namespace UnitTests.Routing
{
    ...
    public class MTCG_RouteRegistry
    {
        ...
        [TestCase("/mtcg/user/{userid:int}/", "mtcg/user/abc23", true, HTTPMethod.GET)]
        [TestCase("/mtcg/user/{username:alpha}/", "mtcg/wrong/maximilian234", true, HTTPMethod.PUT)]
        [TestCase("/mtcg/security/{token:alphanum}/", "mtcg/insecurity/testtoken12398sdfkj98", true, HTTPMethod.POST)]
        [TestCase("/mtcg/route/without/params/", "/mtcg/route/with/params/123/", true, HTTPMethod.DELETE)]
